 ...
 */
  module.factory(
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/CoffeeShops/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use CoffeeShop.customers.findById() instead.
            "prototype$__findById__customers": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/CoffeeShops/:id/customers/:fk",
              method: "GET",
            },

            // INTERNAL. Use CoffeeShop.customers.destroyById() instead.
            ...
            // INTERNAL. Use CoffeeShop.customers.updateById() instead.
            ...
            // INTERNAL. Use CoffeeShop.customers() instead.
            "prototype$__get__customers": {
              isArray: true,
              url: urlBase + "/CoffeeShops/:id/customers",
              method: "GET",
            },

            // INTERNAL. Use CoffeeShop.customers.create() instead.
            "prototype$__create__customers": {
              url: urlBase + "/CoffeeShops/:id/customers",
              method: "POST",
            },

            // INTERNAL. Use CoffeeShop.customers.destroyAll() instead.
            "prototype$__delete__customers": {
              url: urlBase + "/CoffeeShops/:id/customers",
              method: "DELETE",
            },

            // INTERNAL. Use CoffeeShop.customers.count() instead.
            "prototype$__count__customers": {
              url: urlBase + "/CoffeeShops/:id/customers/count",
              method: "GET",
            },
    ...
    /**
     * @ngdoc object
     * @name lbServices.CoffeeShop.customers
     * @header lbServices.CoffeeShop.customers
     * @object
     * @description
     *
     * The object `CoffeeShop.customers` groups methods
     * manipulating `Customer` instances related to `CoffeeShop`.
     *
     * Call {@link lbServices.CoffeeShop#customers CoffeeShop.customers()}
     * to query all related instances.
     */
             ...
             * @description
             *
             * Queries customers of CoffeeShop.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
        ...
        R.customers = function() {
          ...
          var action = TargetResource["::get::CoffeeShop::customers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.CoffeeShop.customers#count
             * @methodOf lbServices.CoffeeShop.customers
             *
             * @description
             *
             * Counts customers of CoffeeShop.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
        ...
        R.customers.count = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::count::CoffeeShop::customers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.CoffeeShop.customers#create
             * @methodOf lbServices.CoffeeShop.customers
             *
             * @description
             *
        ...
        R.customers.create = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::create::CoffeeShop::customers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.CoffeeShop.customers#createMany
             * @methodOf lbServices.CoffeeShop.customers
             *
             * @description
             *
        ...
        R.customers.createMany = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::createMany::CoffeeShop::customers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.CoffeeShop.customers#destroyAll
             * @methodOf lbServices.CoffeeShop.customers
             *
             * @description
             *
        ...
        R.customers.destroyAll = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::delete::CoffeeShop::customers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.CoffeeShop.customers#destroyById
             * @methodOf lbServices.CoffeeShop.customers
             *
             * @description
             *
        ...
        R.customers.destroyById = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::destroyById::CoffeeShop::customers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.CoffeeShop.customers#findById
             * @methodOf lbServices.CoffeeShop.customers
             *
             * @description
             *
        ...
        R.customers.findById = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::findById::CoffeeShop::customers"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.CoffeeShop.customers#updateById
             * @methodOf lbServices.CoffeeShop.customers
             *
             * @description
             *
        ...
        R.customers.updateById = function() {
          var TargetResource = $injector.get("Customer");
          var action = TargetResource["::updateById::CoffeeShop::customers"];
          return action.apply(R, arguments);
        };
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Customers/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use CoffeeShop.customers.destroyById() instead.
            "::destroyById::CoffeeShop::customers": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/CoffeeShops/:id/customers/:fk",
            ...
            // INTERNAL. Use CoffeeShop.customers.updateById() instead.
            "::updateById::CoffeeShop::customers": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/CoffeeShops/:id/customers/:fk",
            ...
            // INTERNAL. Use CoffeeShop.customers.create() instead.
            "::create::CoffeeShop::customers": {
              url: urlBase + "/CoffeeShops/:id/customers",
              method: "POST",
            },

            // INTERNAL. Use CoffeeShop.customers.createMany() instead.
            "::createMany::CoffeeShop::customers": {
              isArray: true,
              url: urlBase + "/CoffeeShops/:id/customers",
              method: "POST",
            },
            ...
            // INTERNAL. Use CoffeeShop.customers.destroyAll() instead.
            "::delete::CoffeeShop::customers": {
              url: urlBase + "/CoffeeShops/:id/customers",
              method: "DELETE",
            },

            // INTERNAL. Use CoffeeShop.customers.count() instead.
            "::count::CoffeeShop::customers": {
              url: urlBase + "/CoffeeShops/:id/customers/count",
              method: "GET",
            },
